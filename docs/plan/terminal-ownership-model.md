...
**Status**: MVP floor shipped (2026-07-28), S3-S7 still planning · **Batch**: `docs/plan/backlog-jul27.md` (WS-A), `docs/plan/backlog-jul28-terminal-ux.md` (WS-N) · **Version state**: `package.json` is `1.21.0`; this accumulates in `CHANGELOG.md`'s `[Unreleased]`. No version number appears in this doc or in any file it creates.
