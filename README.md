...
| **Open Popup** | One menu to open a project — **Local:** Finder, Terminal, VSCode, VSCode Insiders, Antigravity; **Remote (SSH):** SSH Terminal, VSCode Remote, VSCode Insiders Remote, Antigravity Remote. Automatically detects project stack (Tauri dev vs Node/Nuxt build & preview) and package manager (pnpm/yarn/bun/npm) to launch the correct commands. Unavailable IDEs are dimmed automatically. |
